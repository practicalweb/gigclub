...
class MemberController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GigclubMembershipBundle:Member')->findAll();
     ...
     * @Method("POST")
     * @Template("GigclubMembershipBundle:Member:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GigclubMembershipBundle:Member')->find($id);
     ...
     * @Method("PUT")
     * @Template("GigclubMembershipBundle:Member:edit.html.twig")
     */
